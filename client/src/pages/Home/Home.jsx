						...
						<div className='flex flex-col items-center justify-between xl:flex-row'>
							<div className='w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12'>
								<div class='flex items-center  -mx-1'>
									<p class='mx-1 text-sm text-[#e6e6e6] dark:text-white'>
										Coming Soon on
									</p>
									<svg
										class='w-6 h-6 mx-1 fill-[#e6e6e6] dark:fill-white'
								...
								<div class='flex items-center mb-8   '>
									<img
										class='object-cover w-12 h-12 rounded-full ring ring-[#ff5722]'
									...
									/>
									<img
										class='object-cover w-12 h-12 -mx-4 rounded-full ring ring-[#ff5722]'
