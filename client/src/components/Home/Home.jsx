    ...
    <div className='mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-24 lg:px-8'>
     ...
     <div className='mt-8 flex lg:mt-0 lg:flex-shrink-0'>
      <div className='inline-flex rounded-md shadow'>
       <a
        href='#'
        className='inline-flex items-center justify-center rounded-md border border-transparent bg-primaryOrange px-5 py-3 text-base font-medium text-white hover:bg-indigo-700'
       >
        Get started
       </a>
      </div>
   ...
   <div className="w-full relative bg-gray-800">
      <div className="h-56  sm:h-72 md:absolute md:left-0 md:h-full md:w-1/2">
        <img 
          ...
          src="https://images.pexels.com/photos/1247746/pexels-photo-1247746.jpeg?auto=compress&cs=tinysrgb&w=800"
          alt=""
        />
      </div>
      <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16 border-b-4 border-primaryOrange">
        <div className="md:ml-auto md:w-1/2 md:pl-10">
          <h2 className="text-lg font-semibold text-gray-300">There’s a song for every emotion.</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">There’s a person for everyone.</p>
          <p className="mt-3 text-lg text-gray-300">
          Let people meet the real you. Connect based on your most intimate feelings - Your music
          </p>
          <div className="mt-8">
            <div className="inline-flex rounded-md shadow">
              <a
