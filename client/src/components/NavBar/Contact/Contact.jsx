	...
	return (
		<>
          ...
          <div className="mx-auto max-w-md pl-4 pr-8 sm:max-w-lg sm:px-8 lg:max-w-7xl lg:px-8">
			...
			giving a million creators the opportunity to live 
			off their art and billions of fans the opportunity 
				...
				<div className='relative sm:py-24 sm:px-6 lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:px-8 lg:py-32'>
					<div className='lg:pr-8'>
						<div className='mx-auto max-w-md sm:max-w-lg lg:mx-0'>
							...
							It’s our culture. It’s our values. It’s who we are and what we’re not. 
							...
							<p className='mt-4 text-lg text-gray-500 sm:mt-3'>
							We’re not just shaping the future of audio. 
							We want to help shape a better future for society and the planet too. 
