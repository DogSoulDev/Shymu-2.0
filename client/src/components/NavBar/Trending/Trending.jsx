...
const products = [
	{
		...
		name: 'Shakira',
		href: '#',
		imageSrc: 'https://www.elnacional.cat/enblau/uploads/s1/36/73/42/68/shakira-en-su-u-ltimo-videoclip.jpeg',
	  ...
	  },
	  {
		...
		name: 'Taylor Swift',
		href: '#',
		imageSrc: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYUUtDH-thLKUTvZz3MkITolkx_E9PWdHh9w&usqp=CAU',
		imageAlt: "Front of men's Basic Tee in black.",
		price: '',
		color: 'Anti-Hero',
	  },
	  {
		...
		name: 'As It Was',
		href: '#',
		imageSrc: 'https://media.vogue.es/photos/628362b937bc84cca63cf0f1/4:3/w_2716,h_2037,c_limit/Harry%20Hero.jpg',
		imageAlt: "Front of men's Basic Tee in black.",
		price: '',
		color: 'Harry Styles',
	  },
	  {
		...
		href: '#',
		imageSrc: 'https://images.genius.com/fe73e901785425383a42561849ff31f9.1000x1000x1.jpg',
		imageAlt: "Front of men's Basic Tee in black.",
		price: '',
...
function Trending() {
	return (
      ...
      <div className="mx-auto max-w-2xl py-8 px-4 sm:py-8 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="text-4xl font-bold tracking-tight text-primaryOrange">Music</h2>
		<h3 className="text-2xl font-bold tracking-tight text-gray-900">Top 4 of the week.</h3>
      ...
      <div className="mx-auto max-w-2xl py-8 px-4 sm:py-8 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="text-4xl font-bold tracking-tight text-primaryOrange">AudioBooks</h2>
		<h3 className="text-2xl font-bold tracking-tight text-gray-900">Top 4 of the week.</h3>
        <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
	...
	<div className="bg-white">
      <div className="mx-auto max-w-2xl py-8 px-4 sm:py-8 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="text-4xl font-bold tracking-tight text-primaryOrange">Podcasts</h2>
		<h3 className="text-2xl font-bold tracking-tight text-gray-900">Top 4 of the week.</h3>
        <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
          {podcast.map((product) => (
            <div key={product.id} className="group relative">
