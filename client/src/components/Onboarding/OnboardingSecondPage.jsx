...
import Singer from "../../assets/img/photo2.jpg";
					...
					<div className='frameboard'>
						...
						<div className='card__text'>
							<h1 className='title_-onboarding plusjakartasans-extra-bold-white-48px'>
								<span className='plusjakartasans-extra-bold-ship-gray-48px'>
									CHAT
								</span>
								<span className='plusjakartasans-extra-bold-outrageous-orange-48px'>
									.
								</span>
							</h1>
							...
							<p className='onboarding_-text inter-normal-dove-gray-15px'>
								Connecting on a shared love of music, makes interactions easy,
								natural and fun
							</p>
						</div>
